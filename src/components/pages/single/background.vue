...
<script lang="coffee">
	module.exports =
		# components:
		# 	cell: require "components/pages/top/background/cell"
		data: ->
			count: 0
			size:
				width: 1024
			...
			symbols: [ # ボーダー
					...
					{ x: 0, y: 50, degree: 0, scale: 1.0, opacity: 1.0 }
					{ x: 50, y: 50, degree: 0, scale: 1.0, opacity: 1.0 }
				]
			animates: [
				# [ # ボーダー大
				# 	{ x: 25, y: 37.5, degree: 0, scale: 2.0, opacity: 1.0 }
				# 	{ x: 25, y: 37.5, degree: 0, scale: 2.0, opacity: 0.0 }
				# 	{ x: 25, y: 37.5, degree: 0, scale: 2.0, opacity: 0.0 }
				# 	{ x: 25, y: 37.5, degree: 0, scale: 2.0, opacity: 0.0 }
				# ]
				[ # ボーダー
				...
				# [ # ジグザグ
				# 	{ x: 0, y: 0, degree: 45, scale: 1.3, opacity: 1 }
				# 	{ x: 0, y: 0, degree: 0, scale: 1.0, opacity: 0.0 }
				# 	{ x: 50, y: 50, degree: 135, scale: 1.3, opacity: 1 }
				# 	{ x: 50, y: 50, degree: 0, scale: 1.0, opacity: 0.0 }
				# ]
			]
		computed:
				...
				if index is this.cells.length-1
					for i in [0..3]
						Velocity $(".s"+i+" .content"), {
							translateX: this.symbols[i].x * this.scale
							translateY: this.symbols[i].y * this.scale
